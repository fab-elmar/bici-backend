...
import { getUserProfile, editUserProfile } from "../controllers/userProfile.js";
...
router.route("/edit").post(upload.single("avatar_img"), editUserProfile);

router.route("/propin").get(getProPin);
